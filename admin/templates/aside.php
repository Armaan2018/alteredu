                                                    ...
                                                    <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
                                                                ...
                                                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                                                    <span class="thumb avatar pull-left m-r"> 
                                                                        ...
                                                                        <img src="images/<?php echo $_SESSION['photo']; ?>" class="dker" alt="..." />
                                                                         ...
                                                                         <i class="on md b-black"></i> </span>
                                                                    <span class="hidden-nav-xs clear">
                                                                        <span class="block m-t-xs"> <strong class="font-bold text-lt"><?php echo $_SESSION['name']; ?></strong> <b class="caret"></b> </span> <span class="text-muted text-xs block"><?php echo $_SESSION['role']; ?></span>
                                                                    </span>
                                                                </a>
                                                        ...
                                                        <nav class="nav-primary hidden-xs">
                                                            ...
                                                            <ul class="nav nav-main" data-ride="collapse">
                                                                ...
                                                                <li class="active">
                                                                    <a href="index.html" class="auto"> <i class="i i-statistics icon"> </i> <span class="font-bold">Students</span> </a>
                                                                </li>
                                                                              <li class="">
                                                                    <a href="index.html" class="auto"> <i class="i i-statistics icon"> </i> <span class="font-bold">Teachers</span> </a>
                                                                </li>
                                                                              <li class="">
                                                                    <a href="index.html" class="auto"> <i class="i i-statistics icon"> </i> <span class="font-bold">Staff</span> </a>
                                                                </li>
